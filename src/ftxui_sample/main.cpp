...
// configuration step. It creates a namespace called `uan`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", uan::cmake::project_name, uan::cmake::project_version) };
